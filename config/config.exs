...
config :rockelivery, Rockelivery.Repo,
  migration_primary_key: [type: :binary],
  migration_foreign_key: [type: :binary]
...
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "SXHKNdE/J5vnYLfzJBZg84p2Zv/WXcYUvsJGPMHhFNrFTeYdDvyxstEdL63+3qyh",
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "esrGrRRM"]
